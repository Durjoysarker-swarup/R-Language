...
## Read file and Some data exploration
```{r}
...
# dataset view
Family_info
print(is.data.frame(Family_info))

#number of row
print(nrow(Family_info))
#number of colulmn
print(ncol(Family_info))

#first six row or just the snipit
head(Family_info)
#Last six row
tail(Family_info)
...
#showing the length of farmer data , how many column are there 
length(Family_info)

#length of the column
length(Family_info$Height)
```
